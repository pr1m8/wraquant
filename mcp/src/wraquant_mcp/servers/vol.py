...
def register_vol_tools(mcp, ctx: AnalysisContext) -> None:
    ...
    def forecast_volatility(
        ...
        try:
            ...
            return {"error": str(e), "tool": "forecast_volatility"}
    ...
    def news_impact_curve(
        ...
        try:
            ...
            return {"error": str(e), "tool": "news_impact_curve"}
    ...
    def model_selection(
        ...
        try:
            ...
            return {"error": str(e), "tool": "model_selection"}
    ...
    def realized_volatility(
        ...
        try:
            ...
            if func is None:
                return {
                    "error": f"Unknown method '{method}'. Options: {list(estimators)}"
                }
            ...
            stored = ctx.store_dataset(
                f"rvol_{dataset}_{method}",
                vol_df,
                source_op="realized_volatility",
                parent=dataset,
            )
            ...
            return {"error": str(e), "tool": "realized_volatility"}
    ...
    def ewma_volatility(
        ...
        try:
            ...
            return {"error": str(e), "tool": "ewma_volatility"}
    ...
    def stochastic_vol(
        ...
        try:
            ...
            return {"error": str(e), "tool": "stochastic_vol"}
        ...
        try:
            ...
            if isinstance(result, dict) and "vrp" in result:
                ...
                stored = ctx.store_dataset(
                    f"vrp_{dataset}",
                    vrp_df,
                    source_op="variance_risk_premium",
                    parent=dataset,
                )
            else:
                stored = {}
            ...
            return {"error": str(e), "tool": "variance_risk_premium"}
    ...
    def bipower_variation(
        ...
        try:
            ...
            return {"error": str(e), "tool": "bipower_variation"}
    ...
    def jump_detection(
        ...
        try:
            ...
            return {"error": str(e), "tool": "jump_detection"}
    ...
    def garch_rolling(
        ...
        try:
            ...
            if isinstance(result, dict) and "forecasts" in result:
                ...
                stored = ctx.store_dataset(
                    f"garch_rolling_{dataset}",
                    fc_df,
                    source_op="garch_rolling",
                    parent=dataset,
                )
            else:
                stored = {}
            ...
            return {"error": str(e), "tool": "garch_rolling"}
