...
def register_backtest_tools(mcp, ctx: AnalysisContext) -> None:
    ...
    def run_backtest(
        ...
        try:
            ...
            return {"error": str(e), "tool": "run_backtest"}
    ...
    def backtest_metrics(
        ...
        try:
            ...
            return {"error": str(e), "tool": "backtest_metrics"}
    ...
    def comprehensive_tearsheet(
        ...
        try:
            ...
            return {"error": str(e), "tool": "comprehensive_tearsheet"}
    ...
    def walk_forward(
        ...
        try:
            ...
            return {"error": str(e), "tool": "walk_forward"}
    ...
    def strategy_comparison(
        ...
        try:
            ...
            return {"error": str(e), "tool": "strategy_comparison"}
    ...
    def omega_ratio(
        ...
        try:
            ...
            return {"error": str(e), "tool": "omega_ratio"}
    ...
    def kelly_fraction(
        ...
        try:
            ...
            return {"error": str(e), "tool": "kelly_fraction"}
    ...
    def regime_backtest(
        ...
        try:
            ...
            for r in range(n_regimes):
                ...
                if mask.sum() > 0:
                    regime_means[r] = (
                        float(returns.iloc[mask].mean())
                        if hasattr(returns, "iloc")
                        else float(returns[mask].mean())
                    )

            sorted_regimes = sorted(
                regime_means.items(), key=lambda x: x[1], reverse=True
            )
            bull_regime = sorted_regimes[0][0]

            # Apply weights
            weights = np.where(regimes == bull_regime, bull_weight, bear_weight)
            strategy_returns = returns * pd.Series(weights, index=returns.index).shift(
                1
            ).fillna(0)
            ...
            stored = ctx.store_dataset(
                f"regime_bt_{dataset}",
                eq_df,
                source_op="regime_backtest",
                parent=dataset,
            )
            ...
            return {"error": str(e), "tool": "regime_backtest"}
    ...
    def vectorized_backtest(
        ...
        try:
            ...
            return {"error": str(e), "tool": "vectorized_backtest"}
    ...
    def drawdown_analysis(
        ...
        try:
            ...
            if isinstance(result, pd.DataFrame):
                stored = ctx.store_dataset(
                    f"drawdowns_{dataset}",
                    result,
                    source_op="drawdown_analysis",
                    parent=dataset,
                )
            ...
            cum_max = equity.cummax()
            current_dd = float(
                ((equity.iloc[-1] - cum_max.iloc[-1]) / cum_max.iloc[-1])
            )
            ...
            return {"error": str(e), "tool": "drawdown_analysis"}
