...
def register_bayes_tools(mcp, ctx: AnalysisContext) -> None:
    ...
    def bayesian_sharpe(
        ...
        try:
            ...
            return {"error": str(e), "tool": "bayesian_sharpe"}
    ...
    def bayesian_regression(
        ...
        try:
            ...
            return {"error": str(e), "tool": "bayesian_regression"}
    ...
    def bayesian_changepoint(
        ...
        try:
            ...
            stored = ctx.store_dataset(
                f"changepoints_{dataset}",
                cp_df,
                source_op="bayesian_changepoint",
                parent=dataset,
            )
            ...
            return {"error": str(e), "tool": "bayesian_changepoint"}
    ...
    def bayesian_portfolio(
        ...
        try:
            ...
            return {"error": str(e), "tool": "bayesian_portfolio"}
    ...
    def bayesian_volatility(
        ...
        try:
            ...
            stored = ctx.store_dataset(
                f"bayes_vol_{dataset}",
                vol_df,
                source_op="bayesian_volatility",
                parent=dataset,
            )
            ...
            return {"error": str(e), "tool": "bayesian_volatility"}
    ...
    def model_comparison_bayesian(
        ...
        try:
            ...
            return {"error": str(e), "tool": "model_comparison_bayesian"}
    ...
    def hmc_sample(
        ...
        try:
            ...
            return {"error": str(e), "tool": "hmc_sample"}
