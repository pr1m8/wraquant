...
def register_ml_tools(mcp, ctx: AnalysisContext) -> None:
    ...
    def build_features(
        ...
        try:
            ...
            return {"error": str(e), "tool": "build_features"}
    ...
    def train_model(
        ...
        try:
            ...
            if func is None:
                return {
                    "error": f"Unknown model '{model_type}'. Options: {list(trainers)}"
                }
            ...
            return {"error": str(e), "tool": "train_model"}
    ...
    def feature_importance(
        ...
        try:
            ...
            return {"error": str(e), "tool": "feature_importance"}
    ...
    def walk_forward_ml(
        ...
        try:
            ...
            return {"error": str(e), "tool": "walk_forward_ml"}
    ...
    def pca_factors(
        ...
        try:
            ...
            return {"error": str(e), "tool": "pca_factors"}
        ...
        try:
            ...
            if isinstance(result, dict) and "anomaly_labels" in result:
                ...
                stored = ctx.store_dataset(
                    f"iforest_{dataset}",
                    anom_df,
                    source_op="isolation_forest",
                    parent=dataset,
                )
                n_anomalies = (
                    int((result["anomaly_labels"] == -1).sum())
                    if hasattr(result["anomaly_labels"], "sum")
                    else None
                )
            else:
                stored = {}
            ...
            return {"error": str(e), "tool": "isolation_forest"}
    ...
    def svm_classify(
        ...
        try:
            ...
            feature_cols = (
                ...
                if feature_cols_json and feature_cols_json != "[]"
                else []
            )
            ...
            return {"error": str(e), "tool": "svm_classify"}
    ...
    def online_regression(
        ...
        try:
            ...
            x_cols = (
                json.loads(x_cols_json) if x_cols_json and x_cols_json != "[]" else []
            )
            ...
            if isinstance(result, dict) and "coefficients" in result:
                ...
                stored = ctx.store_dataset(
                    f"online_reg_{dataset}",
                    coef_df,
                    source_op="online_regression",
                    parent=dataset,
                )
            else:
                stored = {}
            ...
            return {"error": str(e), "tool": "online_regression"}
    ...
    def cross_asset_features(
        ...
        try:
            ...
            stored = ctx.store_dataset(
                f"xasset_{dataset}",
                features,
                source_op="cross_asset_features",
                parent=dataset,
            )
            ...
            return {"error": str(e), "tool": "cross_asset_features"}
